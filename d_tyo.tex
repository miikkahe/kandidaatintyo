...
\cite{Montgomery2012} antaa kokeen
...
Tuloksena on koesuunnitelma ja se esitetään taulukkomuodossa, jossa rivit ovat
koeajoja ja sarakkeisiin merkitään ajossa käytettävät tekijätasot. Esimerkkinä
kuva \todo . 
...
Tietokoneiden kehityttyä on syntynyt myös toinen mahdollisuus, luoda tilanteeseen
mukautettu suunnitelma algoritmin avulla.
