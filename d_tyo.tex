...
\title{Tilastollisen kokeensuunnittelun soveltaminen teollisen mittausprosessin analysointiin ja optimointiin: tapaustutkimus}      % primary title (for front page)
...
(lisää sitaatti se josta otit kuvia) listaa seuraavat ongelmat liittyen
Taguchi -menetelmiin:
\begin{itemize}
\item Lisää tähän
\item nämä asiat
