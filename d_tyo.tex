...
Usein hyödyllisin suunnitelma on \(2^\textit{k\textminus p}\)-koe,
mikä tarkoittaa että koe on \(1/2^\textit(p)\)-osa \(2^\textit{k}\)-kokeesta.
Esimerkiksi \(2^\textit{3\textminus 1}\)-koe on puolikas \(2^\textit{3}\)-kokeesta,
jolloin koeajoja on vain 4 (\(2^\textit{3}\)-kokeessa koeajoja on 8).
\(2^\textit{6\textminus 2}\)-koe on neljäsosa \(2^\textit{6}\)-kokeesta
...
\todo{Taguchi, vastepinta, d-optimal, designated design, Box-Meyers}
...
1950-luvulla ja vaikutti voimakkaasti laadunhallinnan tekniikan kehittymiseen.
...
komponenttiosan leveys on 3 \pm 0,1 mm \todo{näkyykö tämä? ±}
...
\textcite{Sleeper2012} jättää menetelmät kokonaan
