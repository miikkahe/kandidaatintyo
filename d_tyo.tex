...
\textit{sekatasosuunnitelma} (engl.
mixed-level design).
...
\textit{sulautumiseen}
(engl. aliasing tai confounding), mikä tarkoittaa että joitain
...
\textit{vaikutusten niukkuusperiaatetta} (engl. sparsity-of-effects principle),
...
(engl. main factor) erotukseksi useamman tekijän yhteisvaikuksista.
