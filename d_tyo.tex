...
\usepackage[style=authoryear,bibstyle=authoryear,maxcitenames=2,backend=biber,url=false,maxbibnames=100,language=american,autolang=other,firstinits=true,uniquename=init]{biblatex}
