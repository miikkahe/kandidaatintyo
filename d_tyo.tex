...
Usein hyödyllisin suunnitelma on \(2^{k - p}\)-koe,
mikä tarkoittaa että koe on \(1/2^p\)-osa \(2^k\)-kokeesta.
...
löytämisen, joilla hallitsemattomien tekijöiden dispersiovaikutus minimoituu.
\textcite{Bursztyn} antavat yksinkertaisen esimerkin hallitsemattomien tekijöiden
...
tai kallista hallita kokeen aikana. Luonnollisesti jotta merkittävät hallitsemattomat
...
array). Yhdistetyssä suunnitelmassa hallitsemattomia
...
Yhdistetyn suunnitelman etuna suurempi joustavuus, sillä siinä sulautumisia
voidaan hallita tarpeen mukaan.

Myös Taguchin menetelmä ristikkäisen suunnitelman datan analysointiin on
omintakeinen. Hallitsemattomia tekijöitä sisältävien kokeiden analysoinnissa
...
erityisesti hyödynnetä kokeeseen sisällytettyjä hallitsemattomia tekijöitä,
vaikka ne on varta vasten sisällytetty suunnitelmaan. Pohjimmiltaan
...
hallitsematon tekijä, $z_1$, malli on
...
\todo{lisää vastepinta- ja vastemallianalyysi}
