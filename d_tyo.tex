...
\usepackage[style=authoryear,bibstyle=authoryear,maxcitenames=2,backend=biber,url=false,isbn=false,maxbibnames=100,language=american,autolang=other,firstinits=true,uniquename=init]{biblatex}
...
%% Note that option style=numeric works as well, also authoryear
...
Luvuissa \ref{ch:doe,ch:grr,ch:kumip} on esitetty työn aiheeseen
liittyvä tieteellinen teoria. Luku \ref{ch:doe} on työn laajin osa,
ja se käsittelee koesuunnittelua. Luvun \ref{ch:grr} aiheena on
koesuunnitteluun läheisesti liittyvä mittajärjestelmäanalyysi, ja
luvun \ref{ch:kumip} aiheena on tutkimuskohteen, eli kumipyöräabraasiokokeen,
teoria. Luvussa \ref{ch:kokeet} esitetään projektin koejärjestelyt,
kaikki suoritetut kokeet ja niistä saadut koetulokset. Luku \ref{ch:concl}
sisältää koetuloksista tehdyt johtopäätökset sekä koko työn yhteenvedon.
...
ensin kaikista tuloksista tekijän ollessa matalalla tasollaan, sen jälkeen
laskemalla vasteen keskiarvo tekijän ollessa korkealla tasollaan, ja lopuksi
...
%\begin{table}[h]
%  \begin{center}
%  \caption{Esimerkki $2^3$-täysyhdistelykokeesta kolmella tekijällä; passiivinen suunnitelma.}
%  \label{tab:fullf}
%  \begin{tabular}{ | l | c | c | c | c | c | c |}
%    \hline
%     & \textbf{A} & \textbf{B} & \textbf{C} & Tulokset & $\bar{y}$ & $\sigma^2$ \\ \hline
%    1 & $-$ & $-$ & $-$ & 7,78; 7,78; 7,81 & 7,79 & 0,001 \\ \hline
%    2 & + & $-$ & $-$ & 8,15; 8,18; 7,88 & 8,07 & 0,003 \\ \hline
%    3 & $-$ & + & $-$ & 7,50; 7,56; 7,50 & 7,52 & 0,002 \\ \hline
%    4 & + & + & $-$ & 7,59; 7,56; 7,75 & 7,63 & 0,004 \\ \hline
%    5 & $-$ & $-$ & + & 7,54; 8,00; 7,88 & 7,81 & 0,005 \\ \hline
%    6 & + & $-$ & + & 7,69; 8,09; 8,06 & 7,95 & 0,004 \\ \hline
%    7 & $-$ & + & + & 7,56; 7,52; 7,44 & 7,51 & 0,002 \\ \hline
%    8 & + & + & + & 7,56; 7,81; 7,69 & 7,69 & 0,003 \\ \hline
%  \end{tabular}
%  \end{center}
%\end{table}
...
design), useimmiten 2 tai 3 tekijätasolla. Osittaisessa kokeessa ei ajeta
...
enemmän on sulautumisia. Suunnitelmien teossa käytetään hyväksi niin sanottua
...
kolmen tekijän yhteisvaikutus ja niin edelleen.
...
Tietokoneiden avulla voidaan luoda algoritmin tuottamia D-optimaalisia
...
Toisin kuin yleiset koesuunnitelmat, D-optimaaliset suunnitelmat eivät välttämättä ole
...
D-optimaalinen suunnitelma kykenee arvioimaan kaikki yhden parametrin vaikutukset sekä kaikki 2 tekijän yhteisvaikutukset koeajojen määrän pysyessä kuitenkin mahdollisimman pienenä.
...
Usein lisätään yhteisvaikutusta kuvaava termi, esimerkiksi jälleen kahden tekijän tapauksessa
...
jolloin voidaan kuvata sekä päävaikutuksia että kahden tekijän yhteisvaikutuksia.
...
roomalaisilla numeroilla ja isompi resoluutio tarkoittaa vähempiä sulautumisia.
Yleensä on siis järkevää valita suurin mahdollinen resoluutio ottamalla samalla huomioon
...
keskenään tai toisiinsa, mutta 2 tekijän yhteisvaikutukset ovat sulautuneita 3 tekijän
...
samalla kun muut pysyvät valituilla perustasoillaan, ja toistaa
...
takaisin aiemmalle tasolleen. Näin jatketaan kunnes kaikkia tekijöitä on
muutettu. Tutkimuksen mukaan tämä menetelmä voi
...
ja jotka soveltuvat siten hyvin käytettäväksi seulontakokeissa. Esimerkiksi 12 koeajon
PB-suunnitelmassa voidaan tutkia 11 tekijää. Näissä suunnitelmissa
päävaikutukset ovat kuitenkin voimakkaasti sulautuneita yhteisvaikutuksiin.
...
Vastaavasti kuten edellä käsitellyissä tekijöiden vaikutuksissa,
...
vastustuskykyinen satunnaisille muutoksille eli robusti, ja parametrien koska
...
Taguchi vaikutti siten voimakkaasti laadunhallinnan tekniikoiden kehittymiseen.
...
Taguchi nimesi nämä ei-hallittaviksi tekijöiksi (eng. noise factor),
...
ei-hallittavaksi tekijäksi ja kokeessa käytettäisiin vain komponentteja joiden
...
havainnollisia vuorovaikutuskuvaajia. Kuva \ref{fig:slope} kuvaa ei-hallittavan
...
kun ei-hallittava tekijä vaihtelee. Dispersiovaikutuksen kuvaaja on vaakasuorempi kun hitsaustapa
on matalalla tasollaan,
mikä tarkoittaa sitä että hitsaustavan matalampi taso vähentää vasteen varianssia.
...
Hyvä esimerkki Taguchi-menetelmän soveltamisesta on japanilaisen Ina Tile Companyn tapaus 1950-luvulta,
...
vastustuskykyisemmiksi uunin lämpötilan vaihtelulle ja siten myös niiden mitat yhdenmukaisemmiksi.
...
Nämä suunnitelmat
"ristitään" eli sisätaulukon jokainen tekijätasojen yhdistelmä
...
yksinkertainen \(2^1\)-koe. Sisätaulukon 8 koeajoa ja ulkotaulukon 2 koeajoa
ristiöitynä tekevät yhteensä 16 koeajoa, mutta kuvan kokeessa jokainen
yhdistelmä myös toistettiin kolmesti, jolloin saatiin yhteensä 48 tulosta.
...
Taguchin menetelmä ristikkäisen suunnitelman datan analysointiin on myös
...
\textcite{box1988,steinberg1994} ovat osoittaneet muitakin suoritemitta-analyysin
...
luvussa \ref{ch:doe} esitetty tulosten mallintamisen
menetelmä. Esimerkiksi, jos hallittavia tekijöitä on 2, $x_1$ ja $x_2$, ja
ei-hallittavia tekijöitä 1, $z_1$, malli on
...
Yleisesti ottaen monet tilastotieteilijät, matemaatikot ja tutkijat sanovat menetelmän
olevan vanhentunut ja kritisoivat spesifisyyttä, tehottomuutta (pieni resoluutio suhteessa
koeajojen määrään) ja annettujen analysointityökalujen järkevyyttä
(suoritemitta-analyysi).
...
toimivuudesta. Yksi väittelyn ydinkohdista on kysymys ristikkäisten ja yhdistettyjen suunnitelmien
...
\textcite[s.~558]{Montgomery2012} on sitä mieltä että useimmissa tapauksissa yhdistetyt
suunnitelmat ovat paljon tehokkaampia.
Osa erimielisyyksistä liittyy siihen, missä määrin vaikutusten
...
kokeeseen. He havaitsivat että tämä parannus saavutetaan vain
silloin kun
...
joissa vaikuttaa monia tekijöitä ja joissa tavoitteena on vasteen optimointi, kuten esimerkiksi
...
eivätkä ne sovellu merkittävien tekijöiden tunnistamiseen eli seulontaan niin hyvin kuin $2^k$-suunnitelmat
...
sovittamalla tulokset ensimmäisen kertaluvun malliin \ref{eq:1krtluku}.
Tämän jälkeen kohti optimialuetta siirrytään \em jyrkimmän nousun \em
(tai \em jyrkimmän laskun \em) menetelmällä \parencite[s.~479]{Montgomery2012}. Jyrkimmän nousun suunta on se
...
nähdään kuvasta \ref{fig:steepest}. Kokeen tekijä päättää sen,
...
huonontunut sopivuus tuloksiin.
...
Yleisimmin käytetyt suunnitelmat ovat Box-Behnken-suunnitelmat ja keskiökomposiittisuunnitelmat
(eng. Central composite design, CCD). Molemmissa käytetään vähintään kolmea
tekijätasoa kaarevuudeen mallintamiseksi. Joissain CCD-suunnitelmissa käytetään
jopa viittä tekijätasoa. Taulukossa \ref{vpsuunnitelmat} nähdään näitten suunnitelmien vaatimat
...
jälkeen suoritetaan ei-hallittaville tekijöille resoluutio III -tasoinen
...
kohdetta mitataan käyttäjän, menetelmän ja muiden tekijöiden pysyessä samana. Toisinnettavuus
on eri käyttäjistä, menetelmistä ja muista tekijöistä aiheutuvaa vaihtelua.
...
käytetyt muuttujan arvot ovat ne ainoat arvot joista ollaan kiinnostuneita.
...
Yksinkertaisin analyysi on niin sanottu tyypin 1 mittajärjestelmäanalyysi, jossa
...
10 näytekappaleella, 3 käyttäjällä ja 2 tai 3 mittaustoistolla.
...
Usein mittaus vahingoittaa kohdetta tai näytettä jollain tavalla.
...
ovat esittäneet menetelmiä mittajärjestelmäanalyysin tekemiseen
...
jotka ovat tarpeeksi samanlaisia jotta niitä voidaan ajatella samana kappaleena, toisin sanoen
homogeeninen erä. Toistettavuus arvioidaan erän sisäisestä vaihtelusta.
...
Tällöin on erittäin tärkeää, että harkitaan sitä, kuinka perusteltu oletus homogeenisuudesta on.
...
joka käyttäjällä on omat mitattavat kappaleensa, ja siten esimerkiksi käyttäjä
...
suorittamiseksi. Yksi suositus on mahdollisimman monen erilaisen näytekappaleen
...
karheat huiput uurtavat pehmeämpää pintaa, on kyse \em kahden kappaleen abrasiivisesta kulumisesta \em
(eng. two-body abrasive wear). Jos kahden pinnan välissä on kovempia kappaleita
jotka uurtavat molempia pintoja, kutsutaan tätä \em kolmen kappaleen
abrasiiviseksi kulumiseksi \em (eng. three-body abrasive wear).
...
on olemassa standardisoitu koe G65-04 \parencite{Standard2010} eli
...
käytössä ilmeneviä ongelmia. Vaikeimmaksi asiaksi hallita
...
sekä erä kappaleita erilaisilla pinnoitteilla.
...
projektia varten valmistetulla kumipyörällä. Lopuksi suoritetaan
robustien parametrien suunnittelukoe, jolla etsitään ne
hallittavien parametrien arvot (ajoaika, hiekan virtausmäärä ja niin edelleen),
...
Koemäärä osoittautui myös liian pieneksi luotettavien johtopäätösten tekemiseen.

Kuva \ref{fig:t1grr2} näyttää joka koekappaleen molemmat testitulokset rinnakkain.
...
mahdollisuus on näytteiden keskeneräiseksi jäänyt kuivuminen,
...
Aiempi ilmiö oli luultavasti sattumaa tai aiheutui tuntemattomasta virheestä koeprosessissa. Kaiken kaikkiaan tyypin 1 mittajärjestelmäanalyysi ei osoittanut testin olevan epästabiili eli ajan suhteen muuttuva. Toisaalta on huomattava että 32 testiajoa noin 2 päivän aikana ei todennäköisesti ole riittävä määrä kokeita tai aikaa luotettavien tulosten saamiseksi.
...
Koe tehtiin Minitab–ohjelman ohjeiden mukaan, hierarkkisena (nested) sillä kulumiskestävyyskoe on destruktiivinen. Onkin muistettava että kokeen taustalla on oletus pinnoitteiden homogeenisuudesta mikä ei välttämättä ole totuudenmukaista.
...
Odottamattomasti jokaisen $50\times 50$ mm –näytteen massahäviö laski toisella koeajolla mutta vastaavaa ilmiötä ei havaittu $100\times 50$ mm –näytteillä.
...
On mahdollista että teräs on keraamia herkempää hiekkavirran turbulenssille tai että ”kansi --- ei kantta” koejärjestely ei vastaa ”$50\times 50$ mm --- $100\times 50$ mm” koejärjestelyä. Joka tapauksessa tämä nimenomainen koetulos ei puolla hiekkavirran hallintaa kansikappaletta käyttämällä.
...
signaali-kohinasuhdetta, joka yhdistää koetuloksen keskiarvon ja varianssin. Tämä on tarpeetonta sillä projektissa ei
...
Lopulta suunnitelmaksi valikoitui $2^k$ dispersiovaikutusten passiivinen seulontakoe. Toistojen määräksi valikoitui 4, koska 2:een
...
$2^k$-seulontakokeeseen 5 tekijällä ja 4 toistokokeella.
Seulontakokeeseen siksi että dispersioon
vaikuttavista tekijöistä ei oltu lainkaan selvillä. D-optimaaliseen suunnitelmaan
ja vain 5 tekijään päädyttiin jotta koeajojen määrä saatiin pysymään
...
%sagemathcloud={"latex_command":"biber d_tyo.tex"}
