...
kaksitasoinen ei-hallittava tekijä jonka $-$-taso on 2,9 mm ja
+-taso 3,1 mm.
...
toimivuutta robustissa suunnittelussa. Menetelmä on kuten \ref{doe} mainittu
...
\begin{table}[]
\centering
\caption{GR\&R-analyysin parametreja}
\label{table:grr}
\begin{tabular}{@{}ll@{}}
\toprule
Parametri                           & Määritelmä                                              \\ \midrule
