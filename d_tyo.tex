...
hallita. Jälkimmäisiä kutsutaan häiriö- tai kohinatekijöiksi (engl. noise
factor) ja merkitään usein
...
\textcite[pp. 3]{Montgomery2012} antaa kokeen
...
\item Merkittävien hallittavien tekijöiden \textit{x} asettaminen siten, että
	häiriötekijöiden \textit{z} vaikutus on mahdollisimman pieni
\end{itemize}
...
järkevästi normaalin alueen ulkopuolelle johtaa usein informatiivisempiin
tuloksiin.
...
\cite{Li2006} ovat tehneet meta-analyysin yhdistelykokeissa esiintyvistä
...
yhteisvaikutuksiin ja päävaikutukset ovat sulautuneita 4 tekijän yhteisvaikutuksiin.
\end{description}
...
Siten esimerkiksi \cite{Montgomery2012}
...
Kuitenkin \cite{frey2005mechanisms} osoittavat tämän
...
kaikista vaikutuksista). \cite{frey2005mechanisms} esittävät
myös mekanismeja ja selityksiä tälle tulokselle.


\todo{Screenaus suom. seulontakoe}
...
\todo{muista lisätä tähän six sigma ja Taguchi vs. perinteinen, "tieteellinen" DOE}
...
Taguchin menetelmiin.\textcite{Sleeper2012} jättää menetelmät kokonaan
...
\item Signaali-kohinasuhde ei kerro kuinka ohjaustekijät vaikuttavat
      ...
      muuttaako se vasteen keskiarvoa, vaihtelua vai molempia.
...
\cite{nair1992} ovat koonneet kattavan paneelikeskustelun Taguchi-menetelmän
...
\textcite{kunert2003experiment}.
Osa erimielisyyksistä liittyy siihen, missä määrin ns. vaikutusten
niukkuusperiaatetta pidetään perusteltuna \textcite{Li2006}.

\textcite{Bursztyn} vertailevat tutkimuksessaan hajonta
