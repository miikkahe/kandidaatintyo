...
mutta käytössä on  myös termit häiriö- ja kohinatekijä, sillä englanninkieliseksi
...
RSM toteutetaan useina peräkkäisinä kokeina.

RSM:ssä vasteeksi pitää valita varianssi, jolloin kokeissa tarvitaan useita toistoja?
...
Syystä tai toisesta teollisuuteen on vakiintunut tapa tehdä yksinkertainen GR\&R-analyysi
...
\em laajennetusta GR\&R-analyysista. \em Jos esimerkiksi lisätään
...
muihin vastaaviin menetelmiin antaa \textcite{Mast2005}.
...
voidaan destruktiivisen mittausjärjestelmän analyysi toteuttaa ristiöitynä.
...
\todo{onko muuten grr jossa etsitään varianssiin vaikuttavia tekijöitä l. dispersiovaikutuksia
sama kuin dispersiovaikutus-seulonta?}
...
voima, pyörimisaika ja ..., että ei-hallittavia parametrejä, tässä mm.
ilmankosteus, pyörän pinnan tasaisuus, ... . On myös jokin tietty vaste,
jonka halutaan olevan keskimäärin tietyllä tasolla vaihtelun ollessa
mahdollisimman pientä. Koesuunnittelun hallittavat ja ei-hallittavat
...
joilla koetulosten hajonta on pienintä. Alustavasti menetelmäksi valittiin
